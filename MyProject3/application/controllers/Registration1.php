...
class Registration1 extends CI_Controller {
	...
	public function index()
	{
		...
		if(isset($_GET["ID"]))
		{
			...
			$view_data['country'] = $this->Country_model->getCountry();
		...
		$this->template->load('master_file', 'Registration_view1',$view_data,false,"Registration_header.php","Registration_footer.php");
