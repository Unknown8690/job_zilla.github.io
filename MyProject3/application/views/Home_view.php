                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="twm-bnr-left-section">
                            <div class="twm-bnr-title-small">We Have <span class="site-text-primary"><?php echo$countsjob['total']; ?></span> Live Jobs</div>
                            ...
                            <div class="twm-bnr-search-bar">
                                <form method="post" action="<?php echo base_url() ?>Jobs">
                                    <div class="row">
                                        <!--Title-->
                                        <div class="form-group col-xl-3 col-lg-6 col-md-6">
                                            <label>What</label>
                                            <input type="text" class="wt-search-bar-select selectpicker" name="keyword"  data-live-search="true" title="" id="j-Job_Title" data-bv-field="size">
                                        </div>

                                        <!--All Category-->
                                        <div class="form-group col-xl-3 col-lg-6 col-md-6">
                                            <label>Category</label>
                                            <select class="wt-search-bar-select selectpicker" name="catname"  data-live-search="true"  data-bv-field="size">
                                        ...
                                        <div class="form-group col-xl-3 col-lg-6 col-md-6">
                                            <label>Type</label>
                                            <select class="wt-search-bar-select selectpicker" name=""  data-live-search="true" title="" id="j-All_Category" data-bv-field="size">
                                        ...
                                        <!--Find job btn-->
                                        <div class="form-group col-xl-3 col-lg-6 col-md-6">
                                            <button type="submit" name="btnsubmit" class="site-button">Find Job</button>
                                        </div>
                        ...
                        <div class="twm-bnr-right-content">
                            ...
                            <div class="twm-bnr-right-carousel">
                                <div class="owl-carousel twm-h1-bnr-carousal">
                                    <div class="item">
                                      <div class="slide-img">
                                        <img src="<?php echo base_url(); ?>assets/images/main-slider/slider1/r-img1.png" alt="#">
                                      </div>
                                    </div>
                                    <div class="item">
                                      <div class="slide-img">
                                        <div class="slide-img">
                                            <img src="<?php echo base_url(); ?>assets/images/main-slider/slider1/r-img2.png" alt="#">
                                          </div>
                                      </div>
                                    </div>
                                </div>
                                ...
                                <div class="twm-bnr-blocks-position-wrap">
                                    ...
                                    <div class="twm-bnr-blocks twm-bnr-blocks-position-1">
                                        <div class="twm-icon">
                                            <img src="<?php echo base_url(); ?>assets/images/main-slider/slider1/icon-1.png" alt="">
                                        </div>
                                    ...
                                    <div class="twm-bnr-blocks twm-bnr-blocks-position-2">
                                        <div class="twm-icon">
                                            <img src="<?php echo base_url(); ?>assets/images/main-slider/slider1/icon-2.png" alt="">
                                        </div>
                                        <div class="twm-content">
                                    ...
                                    <div class="twm-bnr-blocks-3 twm-bnr-blocks-position-3">
                                        <div class="twm-pics">
                                            <span><img src="<?php echo base_url(); ?>assets/images/main-slider/slider1/user/u-1.jpg" alt=""></span>
                                            <span><img src="<?php echo base_url(); ?>assets/images/main-slider/slider1/user/u-2.jpg" alt=""></span>
                                            <span><img src="<?php echo base_url(); ?>assets/images/main-slider/slider1/user/u-3.jpg" alt=""></span>
                                            <span><img src="<?php echo base_url(); ?>assets/images/main-slider/slider1/user/u-4.jpg" alt=""></span>
                                            <span><img src="<?php echo base_url(); ?>assets/images/main-slider/slider1/user/u-5.jpg" alt=""></span>
                                            <span><img src="<?php echo base_url(); ?>assets/images/main-slider/slider1/user/u-6.jpg" alt=""></span>
                                        </div>
                                        <div class="twm-content">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="twm-w-process-steps">
                                    ...
                                    <div class="twm-w-pro-top bg-clr-sky">
                                        <div class="twm-media">
                                            <span><img src="<?php echo base_url(); ?>assets/images/work-process/icon1.png" alt="icon1"></span>
                                        </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="twm-w-process-steps">
                                    ...
                                    <div class="twm-w-pro-top bg-clr-pink">
                                        <div class="twm-media">
                                            <span><img src="<?php echo base_url(); ?>assets/images/work-process/icon2.png" alt="icon1"></span>
                                        </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="twm-w-process-steps">
                                    ...
                                    <div class="twm-w-pro-top bg-clr-green">
                                        <div class="twm-media">
                                            <span><img src="<?php echo base_url(); ?>assets/images/work-process/icon3.png" alt="icon1"></span>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="twm-explore-media-wrap">
                                    <div class="twm-media">
                                        <img src="<?php echo base_url(); ?>assets/images/gir-large.png" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="owl-carousel home-client-carousel2 owl-btn-vertical-center">
                                ...
                                <div class="item">
                                    <div class="ow-client-logo">
                                        ...
                                        <a href="employer-list.html"><img src="<?php echo base_url(); ?>assets/client-logo/w1.png" alt=""></a></div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo client-logo-media">
                                        <a href="employer-list.html"><img src="<?php echo base_url(); ?>assets/images/client-logo/w2.png" alt=""></a></div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo client-logo-media">
                                        <a href="employer-list.html"><img src="<?php echo base_url(); ?>assets/images/client-logo/w3.png" alt=""></a></div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo client-logo-media">
                                        <a href="employer-list.html"><img src="<?php echo base_url(); ?>assets/images/client-logo/w4.png" alt=""></a></div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo client-logo-media">
                                        <a href="employer-list.html"><img src="<?php echo base_url(); ?>assets/images/client-logo/w5.png" alt=""></a></div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo client-logo-media">
                                        <a href="employer-list.html"><img src="<?php echo base_url(); ?>assets/images/client-logo/w6.png" alt=""></a></div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo client-logo-media">
                                        <a href="employer-list.html"><img src="<?php echo base_url(); ?>assets/images/client-logo/w1.png" alt=""></a></div>
                                    </div>
                                </div>
                ...
                <div class="container">
                    ...
                    <div class="section-content">
                       <div class="twm-jobs-list-wrap">
                           <ul>
                                <li><?php foreach($data->result() as $row) {?>
                                    <div class="twm-jobs-list-style1 mb-5">
                                        ...
                                        <div class="twm-mid-content">
                                            ...
                                            <p class="twm-job-address"><?php echo $row->location; ?></p>
                                        ...
                                        <div class="twm-right-content">
                                            ...
                                            <a href="<?php echo base_url() ?>Jobs" class="twm-jobs-browse site-text-primary">Browse Job</a>
                                        </div>
                                    </div>
                                </li>
                           ...
                           <div class="text-center m-b30">
                                <a href="<?php echo base_url() ?>Jobs" class=" site-button">Browse All Jobs</a>
                           </div>
                       </div>
                    </div>
