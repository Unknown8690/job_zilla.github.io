 ...
 <br>
        <div class="page-content">
            ...
            <div class="section-full  p-t0 p-b90 bg-white">
                ...
                <div class="twm-top-wide-banner overlay-wraper" style="background-image:url(http://localhost/MyProject3/assets/images/detail-pic/company-bnr1.jpg);">
                    ...
                    <div class="twm-top-wide-banner-content container ">
                        ...
                        <div class="twm-mid-content">
                            <div class="twm-employer-self-top">
                                <div class="twm-media">
                                    <img src="<?php echo base_url(); ?><?php echo $details['image']; ?>" alt="#">
                                </div>

                                <h3 class="twm-job-title"><?php echo $details['company_name']; ?></h3>
                                <p class="twm-employer-address"><i class="feather-map-pin"></i><?php echo $details['company_address']; ?></p>

                                <a href="<?php echo $details['company_website']; ?>" class="twm-employer-websites"><?php echo $details['company_website']; ?></a>
