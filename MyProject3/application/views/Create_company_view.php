                ...
                <div class="panel panel-default">
                    <div class="panel-heading wt-panel-heading p-a20">
                        ...
                        <div class="twm-nav-btn-left">
                                        <button  data-bs-toggle="modal" class="site-button" href="#sign_up_popup" role="button" onclick="user()" style="float: right;">Add Company</button>
                                ...
                                <tbody>
                                   ...
                                   $data = '<tr>
                                      ...
                                      $data .=  '
                                       ...
                                       </td><td><a href="javascript:;" class="site-text-primary">&nbsp;'.$row->create_at.'</a></td>
                                        ...
                                        <a class="twm-nav-sign-up" data-bs-toggle="modal" href="#sign_up_popup" role="button" onclick="adduser('.$row->Id.')">
                                            <i class="fa fa-pen"></i>
                                                   ...
                                                   <input type ="hidden" id="hiddenname'.$row->Id.'" value="'.$row->company_name.'">
                                                   <input type ="hidden" id="hiddenpassword'.$row->Id.'" value="'.$row->password.'">
                                                   <input type ="hidden" id="hiddenemail'.$row->Id.'" value="'.$row->email.'">
                                                   <input type ="hidden" id="hiddenmobile'.$row->Id.'" value="'.$row->mobile.'">
                                                    <li>
                                                        <a href="'.base_url().'EMP/Company/deleteCompany?Id='.$row->Id.'"> <span class="far fa-trash-alt"></span></a>
        ...
        <div class="modal fade twm-sign-up" id="sign_up_popup" aria-hidden="true" aria-labelledby="sign_up_popupLabel" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <form method="post" action="<?php echo base_url(); ?>EMP/Company/addupdatecompany">

                            <div class="modal-header">
                                <h2 class="modal-title" id="sign_up_popupLabel">Company</h2>
                                <p></p>
