                                     ...
                                     <div class="col-lg-6 col-md-6">
                                         <div class="twm-employer-grid-style1 mb-5">
                                             ...
                                             <div class="twm-mid-content">
                                                 ...
                                                 <p class="twm-job-address"><?php  echo $row->company_address; ?></p>
                                                 <a href="<?php echo base_url(); ?>Company_grid_details?Id=<?php echo $row->co_id; ?>" target="_blank" class="twm-job-websites site-text-primary">View More</a>
                                                    
                                             </div>
                                             <div class="twm-right-content">
                                                 <div class="twm-jobs-vacancies"><span><?php echo ""; ?></span>Vacancies</div>
                                             </div>
                                         </div>
                                     </div>
                                  <?php } ?>
