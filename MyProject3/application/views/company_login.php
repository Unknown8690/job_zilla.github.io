           ...
           <?php }
            ...
            ?>
                                        ...
                                        <div class="tab-content" id="myTab2Content">
                                            ...
                                            <form  method="post" action="<?php echo base_url(); ?>Auth/Company_login/process" id="regform" name="regform" onsubmit="return validate()">  
                                            <div class="tab-pane fade show active" id="twm-login-candidate">
                                                <div class="row">
                                                    
                                                    <div class="col-lg-12">
                                                        <div class="form-group mb-3">
                                                            <input name="company_name" id="company_name" type="text" class="form-control"  placeholder="Email" required>
                                                            <span id="Email"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                       ...
                                                       <div class="col-lg-12">
                                                        <div class="twm-forgot-wrap">
                                                            <div class="form-group mb-3">
                                                                    ...
                                                                    <label class="form-check-label rem-forgot" for="Password4">If you are not Register <a href="<?php echo base_url(); ?>Auth/Company_registration" class="site-text-primary">click Here</a></label>
                                                                </div>
                                                            </div>
                                                        </div>
