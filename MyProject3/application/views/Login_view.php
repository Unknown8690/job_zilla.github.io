           ...
           <?php }
            ...
            ?>
                                        ...
                                        <div class="tab-content" id="myTab2Content">
                                            ...
                                            <form  method="post" action="<?php echo base_url(); ?>Auth/Login/process" id="regform" name="regform" onsubmit="return validate()">  
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="twm-forgot-wrap">
                                                            <div class="form-group mb-3">
                                                                <div class="form-check">
                                                                    ...
                                                                    <label class="form-check-label rem-forgot" for="Password4">Remember me <a href="<?php echo base_url()?>Auth/Forget_password" class="site-text-primary">Forgot Password</a></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" name="submit" class="site-button">Log in</button>
                                                        </div>
                                                    </div>
                                                       <div class="col-lg-12">
                                                        <div class="twm-forgot-wrap">
                                                            <div class="form-group mb-3">
                                                                    ...
                                                                    <label class="form-check-label rem-forgot" for="Password4">If you are not Register <a href="<?php echo base_url(); ?>Auth/Registration" class="site-text-primary">click Here</a></label>
                                                                </div>
                                                            </div>
                                                        </div>
