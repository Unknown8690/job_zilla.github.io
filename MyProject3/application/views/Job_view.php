                            ...
                            <div class="side-bar">
                                ...
                                <div class="sidebar-elements search-bx">
                                    ...
                                    <form method="post" action="<?php echo base_url() ?>Jobs">
                                       ...
                                       <input type="hidden" id="hiddenname" value="<?php echo $Types; ?>">
                                        ...
                                        <div class="twm-sidebar-ele-filter">
                                            ...
                                            <select class="wt-select-bar-large selectpicker" id="type" name="type"  data-live-search="true" data-bv-field="size">
                                          ...
                                          <div class="form-group mb-4">
                                            ...
                                            <button type="submit" id="btnsubmit" name="btnsubmit" value="Update" class="site-button">Submit</button>
                                            <script type="text/javascript">
                               ...
                               <div class="row">
                                     ...
                                     <?php 
                                       ...
                                       <input type="hidden" name="hidpostdate<?php echo $row->Id?>" value="<?php echo $row->create_at; ?>">
                                        ...
                                        <br>
                                        <center>
                <div class="pagination"><?php echo $page; ?></div></center>          
