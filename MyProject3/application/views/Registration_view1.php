    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
         ...
         <div class="br-section-wrapper">
          <h6 class="br-section-label">Registration Form</h6>
          <p class="br-section-text">Below is an example of a basic horizontal form wizard.</p>
          ...
          <div id="wizard6">
            ...
            <section>
              <p>Try the keyboard navigation by clicking arrow left or right!</p>
                ...
                <input id="UserId" class="form-control" name="UserNo" value="<?php echo isset($_GET["ID"])? $data->row(0)->User_ID:'';?>" placeholder="Enter UserId " type="text" required>
                </div>
                
                
                 <div class="form-group col-md-6">
                <label class="form-control-label">Property Name : <span class="tx-danger">*</span></label>
                <input id="PropertyName2" class="form-control" name="Property" value="<?php echo isset($_GET["ID"])? $data->row(0)->Property_Name:''; ?>" placeholder="Enter Property Name" type="text" required>
              </div>
              
              
                <div class="form-group col-md-6">
                <label class="form-control-label">Address 1 : <span class="tx-danger">*</span></label>
                <input id="Address1" class="form-control" name="address" value="<?php echo isset($_GET["ID"])? $data->row(0)->Address:''; ?>" placeholder="Enter Address1" type="text" required>
              </div>
