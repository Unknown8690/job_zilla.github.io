           ...
           <?php }
            ...
            ?>
                                        ...
                                        <div class="tab-content" id="myTab2Content">
                                            ...
                                            <form  method="post" action="<?php echo base_url(); ?>Auth/Registration/process" id="regform" name="regform" >  
                                            <div class="tab-pane fade show active" id="twm-login-candidate">
                                                <div class="row">

                                                    <div class="col-lg-12">
                                                        <div class="form-group mb-3">
                                                            <input name="username" id="username" type="text" class="form-control" placeholder="Usearname*" required>
                                                       ...
                                                       <div class="col-lg-12">
                                                        <div class="twm-forgot-wrap">
                                                            <div class="form-group mb-3">
                                                                    ...
                                                                    <label class="form-check-label rem-forgot" for="Password4">If you are already Register <a href="<?php echo base_url()?>Auth/Login" class="site-text-primary">click Here</a></label>
                                                                </div>
                                                            </div>
                                                        </div>
