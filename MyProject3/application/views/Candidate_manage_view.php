                            ...
                            <table id="jobs_bookmark_table" class="table table-bordered twm-bookmark-list-wrap">
                                ...
                                <tbody>
                                   ...
                                   $data = '<tr>
                                      ...
                                      $data .=  '</td><td><a href="javascript:;" class="site-text-primary">&nbsp;Applied</a></td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="twm-table-controls">
                                                <ul class="twm-DT-controls-icon list-unstyled">
                                                    <li>
                                                       <a href="'.base_url().'EMP/Manage_candidate/candidatedetails?Id='.$row->user_id.'"><button title="View Candidate" data-bs-toggle="tooltip" data-bs-placement="top">
