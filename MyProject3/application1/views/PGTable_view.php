        ...
        <div class="br-section-wrapper">
          ...
          <table id="example1" class="table table-bordered table-striped">
                        ...
                        foreach($data->result() as $item){
                            echo "<tr>
                                            <td>".$item->ID."</td>
                                                <td>".$item->Comman_ID."</td>
                                                <td>".$item->Title."</td>
                                                <td> ".$item->Comment."</td>
												<td> ".$item->Is_real_estate."</td>
												<td> ".$item-> CreatedBy."</td>
                                                <td>".$item->DateTime."</td>
                                                 <td><a href=Commanedit?ID=".$item->ID."><span style='color:green;' class='fa fa-edit'></span></a>
												
												 &nbsp;&nbsp;<a href ='CommonTable/procees/".$item->ID."' onclick=\"return confirm('Are you sure?')\"><span style = 'Color:red;' class='btn btn-danger btn-xs'></span></a></td>
        </tr>";
