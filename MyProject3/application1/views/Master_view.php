...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url();?>lib/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet">
		...
		<link href="<?php echo base_url();?>lib/highlightjs/styles/github.css" rel="stylesheet">
  ...
  <body>
      ...
      <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
          ...
          <ul class="br-menu-sub">
            ...
            <li class="sub-item"><a href="form-wizards.html" class="sub-link active">Form Wizards</a></li>
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagetitle">
        ...
        <div>
          <h4>Form Wizards</h4>
          <p class="mg-b-0">jQuery Steps, an all-in-one wizard plugin that is extremely flexible, compact and feature-rich.</p>
        </div>
      </div><!-- d-flex -->

      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="br-section-label">Basic Content Wizard</h6>
          ...
          <p class="br-section-label-sm">HTML Code</p>
...
&lt;/div&gt;</code></pre>
  ...
  titleTemplate: '<span class="number">#index#</span> #title#'
          ...
          <p class="br-section-text">A basic form wizard with form validation using Parsley js form validation plugin.</p>
          ...
          <p class="br-section-label-sm">Additional Option Code</p>
  ...
  // Always allow step back to the previous step even if the current step is not valid.
          ...
          <h6 class="br-section-label">Vertical Orientation Wizard</h6>
          <p class="br-section-text">A basic content wizard with vertical orientation.</p>
          ...
          <h6 class="br-section-label">Step Indicator Auto Equal Width</h6>
          <p class="br-section-text">A basic wizard that adds a custom style to make the step indicator equal width.</p>
          ...
          <p class="br-section-label-sm">Additional Option Code</p>
          <pre><code class="javascript pd-20">cssClass: 'wizard step-equal-width'</code></pre>


          <h6 class="br-section-label">Custom Style For Step Indicator</h6>
          <p class="br-section-text">Below are a simple styles for step indicaator of a wizard</p>
          ...
          <p class="br-section-label-sm">Additional Option Code</p>
          <pre><code class="javascript pd-20">cssClass: 'wizard wizard-style-1'</code></pre>

          <div id="wizard6" class="mg-t-80">
            <h3>Personal Information</h3>
            <section>
              <p>Try the keyboard navigation by clicking arrow left or right!</p>
            </section>
          ...
          <p class="br-section-label-sm">Additional Option Code</p>
          <pre><code class="javascript pd-20">cssClass: 'wizard wizard-style-2'</code></pre>

          <div id="wizard7" class="mg-t-80">
            <h3>Personal Information</h3>
            <section>
              <p>Try the keyboard navigation by clicking arrow left or right!</p>
            </section>
          ...
          <p class="br-section-label-sm">Additional Option Code</p>
          <pre><code class="javascript pd-20">cssClass: 'wizard wizard-style-3'</code></pre>
