...
<html lang="en">
  <head>
    ...
    <title>Form Wizards Design - Bracket Plus Responsive Bootstrap 4 Admin Template</title>
...
<?php print_r($data->result()); ?> 
        <form method="post" action="<?php echo site_url('Registration1/Process'); ?>">
        ...
        <div class="box-body">
          <div id="wizard6">
            ...
            <div class="form-group col-md-6">
                ...
                <input id="Longitude3" class="form-control" name="UserNo" placeholder="Enter User ID" type="text" value="<?php echo isset($_GET["ID"])? $data->row(0)->User_ID :''; ?>" required>
                </div>
           
           
              
                <div class="form-group col-md-6">
                                        <label  > Select Your Self   :</label>
                                        <select id='sel_city' name="drpyourself" class="form-control" >
                                            <option>--Select Your Self--</option>
                                        <?php
										foreach($self as $city){
											echo "<option value='".$city['ID']."'>".$city['yourself']."</option>";
										}
										?>
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->Property_Type:''; ?>';
                    </script>
                                        </div>
                 ...
                 <div class="form-group col-md-6">
                                        ...
                                        <select id='sel_city' name="drpwant" class="form-control" >
                                            <option>--I want To--</option>
                                        <?php
										foreach($want as $city){
											echo "<option value='".$city['ID']."'>".$city['i_want_to']."</option>";
										}
										?>
                 ...
                 <div class="form-group col-md-6">
                                        ...
                                        <select id='sel_city' name="drpkindproperty" class="form-control" >
                                            <option>--kind of property--</option>
                                        <?php
										foreach($kind as $city){
											echo "<option value='".$city['ID']."'>".$city['kindproperty']."</option>";
										}
										?>
              ...
              <!--  <div class="form-group col-md-6">
                                        ...
                                        <select id='sel_city' name="drpProperty" class="form-control" >
                                            <option>--Select Property Type--</option>
                                        <?php
										foreach($Property as $city){
											echo "<option value='".$city['ID']."'>".$city['PropertyType']."</option>";
										}
										?>
              ...
              <!--  <div class="form-group col-md-6">
                                        ...
                                        <select id='sel_city' name="drpCountry" class="form-control" >
                                            <option>--Select Country --</option> 
                                        <?php
										foreach($country as $city){
											echo "<option value='".$city['ID']."'>".$city['CountryName']."</option>";
										}
										?>
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city2").value = '<?php echo isset($_GET["ID"])? $data->row(0)->CountryID:''; ?>';
                    </script>
                                        </div>
             ...
             <div class="form-group col-md-6">
                                        <label  > Select StateName   :</label>
                                        <select id='sel_city' name="drpState" class="form-control" >
                                             <option>--Select StateName --</option>
                                        <?php
										foreach($state as $city){
											echo "<option value='".$city['ID']."'>".$city['StateName']."</option>";
										}
										?>    
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city2").value = '<?php echo isset($_GET["ID"])? $data->row(0)->StateID:''; ?>';
                    </script>
                                        </div> -->
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city4").value = '<?php echo isset($_GET["ID"])? $data->row(0)->CityID :''; ?>';
                    </script>
                                        </div>
            ...
            <section>
             ...
             <div class="form-group col-md-6">
               ...
               <input id="Address" class="form-control" name="Address" placeholder="Enter Address " value="<?php echo isset($_GET["ID"])? $data->row(0)->Address:''; ?>" type="text" required>
              </div>
              
              
               <div class="form-group col-md-6">
                <label class="form-control-label">Latitude: <span class="tx-danger">*</span></label>
                 <input id="Latitude" class="form-control" name="latitude" placeholder="Enter Latitude " value="<?php echo isset($_GET["ID"])? $data->row(0)->Latitude:''; ?>" type="text" required>
                </div>
                
                 <div class="form-group col-md-6">
                <label class="form-control-label">Longitude : <span class="tx-danger">*</span></label>
                <input id="Longitude3" class="form-control" name="longitude" placeholder="Enter Longitude" type="text" value="<?php echo isset($_GET["ID"])? $data->row(0)->Longitude :''; ?>" required>
                </div>
                
                   <div class="form-group col-md-6">
                <label class="form-control-label">Expected Price : <span class="tx-danger">*</span></label>
                <input id="ExpectedPrice" class="form-control" name="ExpectedPrice" placeholder="Enter Expected Price" type="text" value="<?php echo isset($_GET["ID"])? $data->row(0)->Longitude :''; ?>" required>
                </div>
                
                
                   <div class="form-group col-md-6">
                                        <label  > Project Status :</label>
                                        <select id='sel_city' name="drpprojectstatus" class="form-control" >
                                         <option>--Project Status --</option>
                                        <?php
										foreach($Project as $city){
											echo "<option value='".$city['ID']."'>".$city['Projectstatus']."</option>";
										}
										?>
            ...
            <!--  
               <div class="form-group">
                     <label class="form-control-label">House Type : <span class="tx-danger">*</span></label>          <br>
              <input type="radio" name="House"
<?php if (isset($House) && $gender=="1BHK") echo "checked";?>
value="female">1BHK
<input type="radio" name="House"
<?php if (isset($House) && $gender=="2BHK") echo "checked";?>
value="male">2BHK
<input type="radio" name="House"
<?php if (isset($House) && $gender=="3BHK") echo "checked";?>
value="other">3BHK
 <input type="radio" name="House"
<?php if (isset($House) && $gender=="4BHK") echo "checked";?>
value="female">4BHK
<input type="radio" name="House"
<?php if (isset($House) && $gender=="4+BHK") echo "checked";?>
value="male">4+BHK
              ...
              -->
                ...
                <input id="Area1" class="form-control" name="area" placeholder="Enter Area " value="<?php echo isset($_GET["ID"])? $data->row(0)->Area:''; ?>" type="text" required>
                </div>
            ...
            <section>
               ...
               <div class="form-group col-md-6">
                <label class="form-control-label">Total_floors : </label>
                <input id="Totalfloors" class="form-control" name="Totalfloors" placeholder="Enter Total floors" type="text" value="<?php echo isset($_GET["ID"])? $data->row(0)->Total_floors :''; ?>" required>
                </div>
                
                   <div class="form-group col-md-6">
                <label class="form-control-label">property on floor : </label>
                <input id="Discount1" class="form-control" name="propertyonfloor" placeholder="Enter property on floor" type="text" value="<?php echo isset($_GET["ID"])? $data->row(0)->property_on_floor :''; ?>" required>
                </div>
                
                    <div class="form-group col-md-6">
                <label class="form-control-label">Parking : </label>
                <input id="Parking" class="form-control" name="Parking " placeholder="Enter Parking number" type="text" value="<?php echo isset($_GET["ID"])? $data->row(0)->Parking  :''; ?>" required>
                </div>
                ...
                <input id="Discount1" class="form-control" name="discount" placeholder="Enter Discounts" type="text" value="<?php echo isset($_GET["ID"])? $data->row(0)->Discount :''; ?>" required>
                </div>
                
                  <div class="box-footer">  <div class="form-group col-md-6">
