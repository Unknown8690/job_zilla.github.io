      ...
      <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
          ...
          <ul class="br-menu-sub nav flex-column">
            ...
            <li class="sub-item"><a href="table-datatable.html" class="sub-link active">Data Table</a></li>
          </ul>
        </li><!-- br-menu-item -->
        <li class="br-menu-item">
          <a href="#" class="br-menu-link with-sub">
                            ...
                            echo "<tr>
                                            <td>".$item->FirstName."</td>
                                                ...
                                                <td>".$item->PostingDate."</td>
                                                 <td><a href=Profile?ID=".$item->Email."><span style='color:green;' class='fa fa-edit'></span></a>
												  &nbsp;&nbsp;<a href='Table/Process/".$item->id."' onclick=\"return confirm('Are you sure?')\" ><span style='color:red;' class='fa fa-trash-o'></span></a></td>
                                            </tr>";
                        }
                        ?>
