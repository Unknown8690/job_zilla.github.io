<script src="<?php echo base_url();?>lib/jquery/jquery.min.js"></script>
    ...
    <script src="<?php echo base_url();?>lib/flot-spline/js/jquery.flot.spline.min.js"></script>
    <script src="<?php echo base_url();?>lib/jquery-sparkline/jquery.sparkline.min.js"></script>
    <script src="<?php echo base_url();?>lib/echarts/echarts.min.js"></script>
    <script src="<?php echo base_url();?>lib/select2/js/select2.full.min.js"></script>
    <script src="http://maps.google.com/maps/api/js?key=AIzaSyAq8o5-8Y5pudbJMJtDFzb8aHiWJufa5fg"></script>
    <script src="<?php echo base_url();?>lib/gmaps/gmaps.min.js"></script>

    <script src="<?php echo base_url();?>js/bracket.js"></script>
    <script src="<?php echo base_url();?>js/map.shiftworker.js"></script>
