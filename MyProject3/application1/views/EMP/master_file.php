    ...
    <div class="br-sideleft sideleft-scrollbar">
      ...
      <ul class="br-sideleft-menu">
        <li class="br-menu-item">
          <a href="<?php echo base_url(); ?>EMP/Dash" class="br-menu-link active">
        ...
        <li class="br-menu-item">
          ...
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="<?php echo base_url(); ?>EMP/GRN" class="sub-link">GRN Entry</a></li>
