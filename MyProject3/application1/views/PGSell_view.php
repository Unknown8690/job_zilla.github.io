...
<?php print_r($data->result()); ?> 
        <form method="post" action="<?php echo site_url('Commanedit/Process'); ?>">
        <input type="hidden" name="hidid" value="<?php echo $this->input->get("ID");?>">
        <div class="box-body">
          <div id="wizard6">
           
                <div class="form-group col-md-6">
                <label class="form-control-label">real estate ID : <span class="tx-danger">*</span></label>
                <input id="realestate " class="form-control" name="CommanID" value="<?php echo isset($_GET["ID"])? $data->row(0)->real_estate_ID : '';?>" placeholder="" type="text" required>
                </div>
                 ...
                 <div class="form-group col-md-6">
                                        ...
                                        <select id='sel_city' name="drprealestate" class="form-control" >
                                          
                                        <?php
										foreach($Real as $city){
											echo "<option value='".$city['ID']."'>".$city['realestate']."</option>";
										}
										?>
              
                    </select>
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->real_estate_Type:''; ?>';
                    </script>
                                        </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->Is_real_estate:''; ?>';
                    </script>
                                        </div>
                 ...
                 <div class="form-group col-md-6">
                <label class="form-control-label">SellerID : <span class="tx-danger">*</span></label>
                <input id="Created" class="form-control" name="Created" placeholder="" value="<?php echo isset($_GET["ID"])? $data->row(0)->CreatedBy:''; ?>" type="text" required>
                </div>
                
                 <div class="form-group col-md-6">
                <label class="form-control-label">BuyerID : <span class="tx-danger">*</span></label>
                <input id="Created" class="form-control" name="Created" placeholder="" value="<?php echo isset($_GET["ID"])? $data->row(0)->BuyerID:''; ?>" type="text" required>
                </div>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->Is_Parking:''; ?>';
                    </script>
                                        </div>
                ...
                <input id="Created" class="form-control" name="SecurityDeposit" placeholder="" value="<?php echo isset($_GET["ID"])? $data->row(0)->Security_Deposit :''; ?>" type="text" required>
                </div>
                
                
                 <div class="form-group col-md-6">
                                        <label  >  	Is Independent kabat :</label>
                                        <select id='sel_city' name="drprealestate" class="form-control" >
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)-> 	Is_Independent_kabat:''; ?>';
                    </script>
                                        </div>
                                        
                                          <div class="form-group col-md-6">
                <label class="form-control-label">No Of Bad: <span class="tx-danger">*</span></label>
                <input id="Created" class="form-control" name="NoOfBad" placeholder="" value="<?php echo isset($_GET["ID"])? $data->row(0)->No_Of_Bad:''; ?>" type="text" required>
                </div>
                                        
                                        
                                         <div class="form-group col-md-6">
                                        <label  > Is Power Backup:</label>
                                        <select id='sel_city' name="drprealestate" class="form-control" >
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->Is_Power_Backup:''; ?>';
                    </script>
                                        </div>
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->Is_Shared:''; ?>';
                    </script>
                                        </div>
                                        
                                         <div class="form-group col-md-6">
                                        <label  >Is Attach BathRoom:</label>
                                        <select id='sel_city' name="drprealestate" class="form-control" >
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->Is_Attach_BathRoom:''; ?>';
                    </script>
                                        </div>
                                        
                                         <div class="form-group col-md-6">
                                        <label  >Is_Kitchen:</label>
                                        <select id='sel_city' name="drprealestate" class="form-control" >
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->Is_Kitchen:''; ?>';
                    </script>
                                        </div>
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->Is_WIFI:''; ?>';
                    </script>
                                        </div>
                                        
                                         <div class="form-group col-md-6">
                                        <label  > Is Freezer :</label>
                                        <select id='sel_city' name="drprealestate" class="form-control" >
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->Is|_Freezer :''; ?>';
                    </script>
                                        </div>
                                        
                                         <div class="form-group col-md-6">
                                        <label  > Is|_Meal_Included  :</label>
                                        <select id='sel_city' name="drprealestate" class="form-control" >
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->Is|_Meal_Included:''; ?>';
                    </script>
                                        </div>
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->Is_CCTV:''; ?>';
                    </script>
                                        </div>
                                        
                                         <div class="form-group col-md-6">
                                        <label  > Is_Security_Gaurd :</label>
                                        <select id='sel_city' name="drprealestate" class="form-control" >
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->Is_Security_Gaurd:''; ?>';
                    </script>
                                        </div>
                                        
                                        
                                          <div class="form-group col-md-6">
                <label class="form-control-label">RentAmt: <span class="tx-danger">*</span></label>
                <input id="Created" class="form-control" name="RentAmt" placeholder="" value="<?php echo isset($_GET["ID"])? $data->row(0)->RentAmt:''; ?>" type="text" required>
                </div>
                
                  <div class="form-group col-md-6">
                <label class="form-control-label">Sell Amt : <span class="tx-danger">*</span></label>
                <input id="Created" class="form-control" name="SellAmt " placeholder="" value="<?php echo isset($_GET["ID"])? $data->row(0)->Sell_Amt:''; ?>" type="text" required>
                </div>
                 ...
                 <div class="form-group col-md-6">
                    ...
                    <script language="javascript">
                    	document.getElementById("sel_city1").value = '<?php echo isset($_GET["ID"])? $data->row(0)->Is_Returnable:''; ?>';
                    </script>
                                        </div>
